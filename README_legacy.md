> **Note**: This file is the previous (upstream-flavored) README, preserved for reference. The current top-level README is [`README.md`](./README.md). Anything in this file may be stale relative to the actual code.
